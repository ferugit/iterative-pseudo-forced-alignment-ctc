...
def main(args):
    ...
    if(os.path.isfile(args.src) and os.path.isdir(args.dst)):
        ...
        prob_chunks = get_speech_prob_file(
            vad,
            args.src,
            large_chunk_size=0.8,
            small_chunk_size=0.4,
        ...
        for segment in boundaries.tolist(): vad_segments.append([args.src, audio_len] + segment)
        ...
        vad_segments_df.to_csv('test_vad_segments.tsv', sep='\t', index=None)
...
if __name__ == '__main__':
    ...
    # Alignment TSV
    parser.add_argument("--src", help="audio file to test", default="")
