...
def main(args):
    ...
    if os.path.isfile(args.tsv):
        ...
        for audio_path in audio_paths:
            ...
            #print('Audio file: ' + str(audio_path)) # 4 debug
            file_transcripts_list = []
            window_size = args.window # s
            steps = int(info.num_frames / (window_size * info.sample_rate))
...
if __name__ == '__main__':
    ...
    # RTVE2018DB
    parser.add_argument("--tsv", help="tsv path", default="")
    parser.add_argument("--dst", help="resultant transcripts", default="data/RTVE2018DB/transcripts/test/")
    parser.add_argument('--window', type=float, default=20.0, help='analysis window (seconds)')
