...
def main(args):
    ...
    if(os.path.isfile(args.partition) and os.path.isdir(args.src)):
        ...
        print('Source file or source directory does not exist')


if __name__ == '__main__':

    parser = argparse.ArgumentParser(description="Script merge aligned files")
    parser.add_argument("--global_tsv", help="original tsv with metadata", default="")
